...
`scripts/ai-dlc/wait-for-deliverable.sh <artifact_path>`, `run_in_background: true`. A
hand-rolled `until`/`sleep` wait is a Rule 29 Check A violation and gate Check 25 counts it.
