...
render() {
  ...
  sub "Push-candidate ledger — CLOSE-CANDIDATE / NAMED-UPSTREAM / NEEDS-REVIEW / RECEIPTS-UNDECIDED / INPUT-UNRESOLVED (upstream absorbed the entry; the operator confirms and annotates, never auto-closed):"
  local lr
