...
render() {
  ...
  sub "Push-candidate ledger — CLOSE-CANDIDATE / NAMED-ABSORBED / NEEDS-REVIEW (upstream absorbed the entry; the operator confirms and annotates, never auto-closed):"
  local lr
