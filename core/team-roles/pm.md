...
- `/effort high`
<!-- {pm_model_personal}: Personal/direct API model string (e.g., claude-sonnet-4-6[1m]) -->
<!-- {pm_model_bedrock}: Bedrock model string (e.g., global.anthropic.claude-sonnet-4-6) -->
