...
Plan authored 2026-09-18 from fresh measurement; this block re-derived the same day after the
0.603.0 merge, per the re-derive action below. Levers are ordered by measured payoff and each
is one release.
