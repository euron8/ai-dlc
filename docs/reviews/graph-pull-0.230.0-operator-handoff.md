...
| 3 | Bank the BEFORE figure — it cannot be retaken after row 4 | graph | — |
| 4 | `apply` on ONE branch, and verify what did and did NOT arrive | graph | — |
| 5 | Advance the machinery stamp | graph | — |
| 6 | Full pre-push, the AFTER figure, commit, push, PR | graph | — |
| 7 | Report back the readings plan §6c-16 needs | graph | — |
