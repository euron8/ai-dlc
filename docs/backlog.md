...
the reference consumer 2026-09-07. **LANDED (v0.525.0).** DEFECT, not BLOCKER: `W7` is a `warn`
...
where the id resolves. Six hook-check citations exist in core prose; five were silent because an
